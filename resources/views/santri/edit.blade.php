            ...
            <div class="card-body">
                ...
                <form action="{{ route('santri.update', $santri->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="gender" class="form-select @error('gender') is-invalid @enderror" required>
                            ...
                            <option value="santriwan"
                                {{ old('gender', $santri->gender) == 'santriwan' ? 'selected' : '' }}>Santriwan</option>
                            <option value="santriwati"
                                {{ old('gender', $santri->gender) == 'santriwati' ? 'selected' : '' }}>Santriwati</option>
                        </select>
                        @error('gender')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        @if ($santri->foto)
                            <div class="mt-3">
                                <img src="{{ asset('storage/' . $santri->foto) }}" width="100" class="img-thumbnail">
